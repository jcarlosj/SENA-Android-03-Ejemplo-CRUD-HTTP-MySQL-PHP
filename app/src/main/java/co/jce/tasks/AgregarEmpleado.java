 ...
 */
public class AgregarEmpleado extends AsyncTask<String,Void,String> {

    Context contexto;
    ProgressDialog loading;

    public AgregarEmpleado( Context contexto ) {
    ...
    protected String doInBackground( String... campos ) {
        ...
        Log .i( "doInBackground", "URL: " + Configuracion .URL_AGREGAR_EMPLEADO );
